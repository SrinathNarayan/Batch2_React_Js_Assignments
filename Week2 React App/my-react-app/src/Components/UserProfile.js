...
const UserProfile = () => {
    ...
    <p className="date"> Date:{User.Dte.toString()}</p>
                    </div>
                    ...
                    <div className="card__info">
                        <span className="card__category"> Current Date</span>
                        <h3 className="card__title">Hover To Viw Current Date</h3>
                ...
                <article className="card card--2">
                    <div className="card__info-hover">
                        ...
                        <p className="date"> Name:  { User.Name}</p>
                        <p className="date"> UserId:  { User.Username}</p>
                        <p className="date"> Email:  { User.Email}</p>
                        <p className="date"> Dept:  { User.Dept}</p>
                        <p className="date"> Experience:  { User.Exp}</p>
                    </div>
                    <div className="card__img"></div>
                    <a href="#" className="card_link">
                        <div className="card__img--hover"></div>
                    ...
                    <div className="card__info">
                        <span className="card__category"> Employee</span>
                        <h3 className="card__title">Hover to View Compelete Details</h3>
